...
class FriendLearner():
    ...
    def __init__(self,env):
        ...
        self.env = env
        self.nA = self.env.nA
        self.q_table = np.random.random((8,8,2,5,5))
        self.error_log = []
        self.iter_list = []
        #np.random.seed(seed)
    ...
    def train_loop(self):
        ...
        for i in range(self.max_iterations):
            ...
            old_q_entry = self.q_table[old_p1_pos,old_p2_pos,old_poss_int,action_1,action_2]
            ...
            reward_1 = reward[0]
            reward_2 = reward[1]
            self.q_table[old_p1_pos,old_p2_pos,old_poss_int,action_1,action_2] = (1-self.current_alpha)*self.q_table[old_p1_pos,old_p2_pos,old_poss_int,action_1,action_2]+self.current_alpha*((1-self.gamma)*reward_1+self.gamma*np.max(self.q_table[new_p1_pos,new_p2_pos,new_poss_int,:,:]))
